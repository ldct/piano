...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function(t) {
    ...
    const randomIdx = function(arr) {
        ...
        const note = ($(".piano span").slice(0, 16), $(d).attr("data-note"));
        notes[note].play();
    }, silence = function() {
        for (var note in notes) notes[note].stop();
    }, chordTypes = {
        major: [ 4, 3 ],
        minor: [ 3, 4 ],
        diminished: [ 3, 3 ],
    ...
    $("#new").off().click(function() {
        ...
        for (var chordType in chordTypes) $("#" + chordType)[0].checked && selectedChordTypes.push(chordTypes[chordType]);
        console.log(selectedChordTypes);
        const randomChord = selectedChordTypes[randomIdx(selectedChordTypes)], keys = $(".piano span"), rootKeys = keys.slice(0, 24 - randomChord[0] - randomChord[1]), aNote = randomIdx(rootKeys), bNote = aNote + randomChord[0], cNote = bNote + randomChord[1];
        window.quizzedNotes = [ aNote, bNote, cNote ], play(keys[aNote]), play(keys[bNote]), 
        play(keys[cNote]);
