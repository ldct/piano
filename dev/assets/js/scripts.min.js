...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function(t) {
    ...
    $("#new").click(function() {
        silence();
        const keys = $(".piano span"), rootKeys = keys.slice(0, 16), rootNote = randomIdx(rootKeys), thirdNote = rootNote + 4, fifthNote = thirdNote + 3;
        window.quizzedNotes = [ rootNote, thirdNote, fifthNote ], play(keys[rootNote]), 
        play(keys[thirdNote]), play(keys[fifthNote]);
